<?php $__env->startSection('title',$samba); ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="shop-banner mb-35 mb-xs-20">
                                    <img src="<?php echo e($img); ?>" style="width: 871px; height: 459px;" alt="">
                                </div>
                                <div class="shop-banner-title">
                                    <h2><?php echo e($samba); ?></h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
						...
						?>
                         <div class="row">
						   <div class="col-12">
							 ...
							 <a href="<?php echo e(url('shop')); ?>" class="btn" style="margin-top: 20px;">View all products</a>
						   </div>
						 </div>
						<?php
						}
