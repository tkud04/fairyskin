                                     ...
                                     <li><a href="#"><i class="fa fa-user-circle-o"></i>Hi, <?php echo e($user->fname); ?></a>
                                        <ul class="ht-dropdown right">
                                            ...
                                            <?php
                                             if($user->role === 'admin'){
                                            ?>
                                              <li><a href="<?php echo e(url('admin-center')); ?>">Admin Center</a></li>
                                            <?php
                                             }
                                            ?>
                                ...
                                <ul>
                                    ...
                                    <ul class="sub-menu">
                                            ...
                                            <?php
                                             foreach($categories as $c){
                                                $url = '#'
                                            ?>
                                            <li><a href="<?php echo e($url); ?>"><?php echo e($c['name']); ?></a></li>
                                            <?php
                                             }
                                            ?>
                                      </ul>
                                    ...
                                    <li><a href="#">About Us</a>
                                      <ul class="sub-menu">
                                        ...
                                        <li><a href="<?php echo e(url('mission-statement')); ?>">Mission Statement</a></li>
                                      </ul>
                                    </li>
