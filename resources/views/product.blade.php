		            ...
		            <div class="col-md-5">
                        ...
                        <div class="product-details-left">
                            <div class="product-details-images slider-lg-image-1 tf-element-carousel" data-slick-options='{
                                ...
                                <div class="lg-image">
                                    <img src="{{$img}}" alt="">
                                    <a href="{{$img}}" class="popup-img venobox" data-gall="myGallery"><i class="fa fa-expand"></i></a>
                                </div>
                                <?php
                                }
                                ?>
                            ...
                            <div class="product-details-thumbs slider-thumbs-1 tf-element-carousel" data-slick-options='{
                               ...
                               <?php
                                foreach($imggs as $img){
                               ?>							
                                <div class="sm-image"><img src="{{$img}}" alt="product image thumb"></div>
                                <?php
                                }
                                ?>
                            </div>
		            ...
		            <div class="col-md-7">
		                ...
		                <div class="product-details-content">
                            ...
                            <div class="single-product-price">
                                <span class="price new-price">&#8358;{{number_format($product['pd']['amount'],2)}}</span>
                            ...
                            <div class="single-product-quantity">
                                <form class="add-quantity" action="#">
                                    ...
                                    <div class="add-to-link">
                                        <button id="add-to-cart-btn" class="product-add-btn" data-cu="{{$cu}}" data-text="add to cart">add to cart</button>
                                    </div>
                                </form>
                           </div>
                    ...
                    <div class="col-md-12">
                        <div class="product-review-tab">
                            ...
                            <ul class="nav dec-and-review-menu">
                                ...
                                <li>
                                <a data-bs-toggle="tab" href="#reviews">Reviews ({{count($reviews)}})</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content product-review-content-tab" id="myTabContent-4">
                                ...
                                <div class="tab-pane fade" id="reviews">
                                    ...
                                    <h2>{{count($reviews)}} review(s) for {{$product['name']}}</h2>
                                    <?php
                                     if(count($reviews) > 0){
                                    ?>
                                    <ul>
                                    ...
                                    <div class="review-form-wrapper">
                                        <div class="review-form">
                                            ...
                                            ?>
                                            <form action="#">
                                               <input type="hidden" id="add-review-product" value="{{$product['sku']}}"/>
                                               <input type="hidden" id="skf" value="{{csrf_token()}}"/>
                                                ...
                                                <div class="input-element" style="margin-top: 40px;">
                                                    ...
                                                    <div class="review-comment-form-author">
                                                        <label>Name </label>
                                                        <input required="required" id="add-review-name" type="text" value="{{isset($user) ? $user->fname.' '.$user->lname : ''}}"/>
                                                    </div>
