                                             ...
                                             <h3>Banners <a href="#" id="add-banner" class="btn btn-primary">Add Banner</a></h3>
                                                ...
                                                <table class="table table-bordered fairyskin-table">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <p>URL: <b>{{$b['url']}}</b></p>
                                                            <p>Top text: <b>{{$b['top_text']}}</b></p>
                                                            <p>Middle text: <b>{{$b['middle_text']}}</b></p>
                                                            <p>Bottom text: <b>{{$b['bottom_text']}}</b></p>
                                                            <p>Action text: <b>{{$b['action_text']}}</b></p>
                                                            <img src="{{$b['img']}}" alt=""/>
                                                        </td>
                                                        <td>{{$b['date']}}</td>
