                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-3 col-md-3 col-6 order-lg-3 order-md-3 order-2 d-flex justify-content-end">
                            ...
                            <div class="header-cart color-white">
                                <a href="{{url('cart')}}"><i class="fa fa-shopping-cart"></i><span>{{$cc}}</span></a>
                                ...
                                <div class="header-cart-dropdown">
                                    ...
                                    <div class="cart-total">
                                        <h5>Subtotal :<span class="float-right">&#8358;{{number_format($subtotal,2)}}</span></h5>
                                        <h5>Total : <span class="float-right">&#8358;{{number_format($subtotal,2)}}</span></h5>
                                    </div>
                                    <div class="cart-btn">
                    ...
                    <div class="col-lg-4 col-md-4">
                        ...
                        <div class="single-categorie">
                            <div class="categorie-image">
                                <img src="{{$p['img']}}" alt="" style="width: 427px; height: 287px;">
                            </div>
                            <div class="categorie-content">
                                <h3>{{$p['topText']}}</h3>
                                <a class="{{$p['url']}}" href="#">{{$p['buttonText']}}</a>
                                <h1>{{$p['bottomText']}}</h1>
                            </div>
                        </div>
