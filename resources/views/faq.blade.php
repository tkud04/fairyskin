...
@section('content')
@include('banner-2',['title' => 'FAQ','subtitle' => 'Frequently Asked Questions']) 
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="faq-content">
                            <div class="faq-desc">
                                <h3>Below are frequently asked questions you might have about Fairyskin Treatment.</h3>
                                <p>We've tried to answer your questions in the best way possible.</p>
                            </div>
                        </div>
                        <!--FAQ Accordin Start-->
