                                ...
                                <tbody>
                                  ...
                                  ?>
                                    <tr>
                                        ...
                                        <td class="pro-quantity"><div class="pro-qty"><input id="cart-qty-{{$product['sku']}}" type="number" value="{{$c['qty']}}"></div></td>
                                        <td class="pro-subtotal"><span>&#8358;{{number_format($subtotal,2)}}</span></td>
                                        <td class="pro-remove">
                                          <a href="{{$ru}}"><i class="fa fa-trash-o"></i></a>
                                          <a href="#" class="update-cart-btn"><i class="fa fa-upload" data-xf="{{$product['sku']}}"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                   }
                            ...
                            <div class="col-lg-6 col-12 mb-30 d-flex">
                                <div class="cart-summary">
                                    <div class="cart-summary-wrap">
                                        <h4>Cart Summary</h4>
                                        <p>Sub Total <span>&#8358;{{number_format($totals['subtotal'],2)}}</span></p>
                                        <p>Shipping Cost <span>&#8358;{{number_format($shipping,2)}}</span></p>
                                        <h2>Grand Total <span>&#8358;{{number_format($shipping + $totals['subtotal'],2)}}</span></h2>
                                    </div>
